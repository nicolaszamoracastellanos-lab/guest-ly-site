...
export type TabSpec = { name: string; icon: IconName; label: string; badge?: number };
    ...
    return (
      <View pointerEvents="box-none" style={[styles.wrap, { bottom }]}>
        <View style={styles.bar}>
          <BlurView intensity={45} tint="dark" style={StyleSheet.absoluteFill} experimentalBlurMethod="dimezisBlurView" />
                ...
                <View>
                  ...
                  {spec.badge ? (
                    <View style={styles.badge}>
                      <Text style={styles.badgeText}>{spec.badge > 99 ? "99" : spec.badge}</Text>
                    </View>
                  ) : null}
                </View>
...
const styles = StyleSheet.create({
  ...
  fill: { ...{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }, backgroundColor: colors.glassFill },
  ...
  badge: { position: "absolute", top: -4, right: -10, minWidth: 16, height: 16, borderRadius: 8, backgroundColor: colors.gold, alignItems: "center", justifyContent: "center", paddingHorizontal: 4 },
  badgeText: { fontFamily: "Jost_600SemiBold", fontSize: 10, color: colors.night },
});
